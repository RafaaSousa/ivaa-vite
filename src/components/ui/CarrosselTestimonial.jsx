      ...
      >
        {testimonials.map((testimonial, index) => (
          <SwiperSlide key={index}>
            <div className="relative z-0 bg-accent flex flex-col pt-10 mb-10 mx-auto items-center">
              <div className="z-10 static bg-primary rounded-[64px] w-[20rem] sm:w-[30rem] pt-8 mt-10 flex flex-col items-center text-center">
                ...
                <div className="z-50 pt-6 mx-10 text-accent">
                ...
                <div className="relative z-10 bottom-0 h-16 rounded-b-[64px] bg-background w-full">
...
export default CarrosselTestimonial;
